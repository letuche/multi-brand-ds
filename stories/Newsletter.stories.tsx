...
const AuroraLogo = () => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'center', marginBottom: 24 }}>
    <svg width="26" height="26" viewBox="0 0 26 26">
      ...
      <circle cx="13" cy="13" r="9" fill="none" stroke="#F0997B" strokeWidth="1.5" />
      <circle cx="13" cy="13" r="12.5" fill="none" stroke="#F5C4B3" strokeWidth="1" />
    </svg>
    <span style={{ fontSize: 18, fontWeight: 700, color: '#4A1B0C', letterSpacing: '-0.4px' }}>Aurora</span>
  </div>
);
...
const NebulaLogo = () => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'center', marginBottom: 24 }}>
    <svg width="26" height="26" viewBox="0 0 26 26">
      ...
      <ellipse cx="13" cy="13" rx="11" ry="4.5" fill="none" stroke="#7F77DD" strokeWidth="1.5" />
      <ellipse cx="13" cy="13" rx="4.5" ry="11" fill="none" stroke="#6A60CC" strokeWidth="1.5" />
    </svg>
    <span style={{ fontSize: 18, fontWeight: 700, color: '#CECBF6', letterSpacing: '-0.4px' }}>Nebula</span>
  </div>
);
...
const NewsletterForm = ({ brand }: NewsletterFormProps) => (
